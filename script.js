...
const cardData = [
  ...
  { name: "细风扶柳", value: "4/3", type: "武器", tier: "二阶", effect: "造成的攻击伤害降低50%。每次攻击时，运势4:，额外造成自己*4的攻击伤害；运势1:本回合额外可以发起一次攻击。" },
  ...
  { name: "黑暗游戏", value: "", type: "状态", tier: "三阶", effect: "禁制：每次发动此效果时必须需要支付5点生命。自己回合开始时对方受到5点伤害并且将一张手牌送入墓地，不这样做的场合受到10伤害。" },
